...
async def on_message(message):
    ...
    if message.content.startswith('!woof'):
        copy_pasta = ("What the fuck did you just fucking say about me, you "
        "little bitch? I'll have you know I graduated top of my class in the "
        ...
        "gorilla warfare and I'm the top sniper in the entire US armed forces. "
        ...
        " can kill you in over seven hundred ways, and that's just with my bare"
        " hands. Not only am I extensively trained in unarmed combat, but I "
        ...
        "known what unholy retribution your little \"clever\" comment was about"
        " to bring down upon you, maybe you would have held your fucking "
        "tongue. But you couldn't, you didn't, and now you're paying the price,"
        " you goddamn idiot. I will shit fury all over you and you will drown "
